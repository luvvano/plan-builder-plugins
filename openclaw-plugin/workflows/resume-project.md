...
<required_reading>
@/Users/egorproskyrin/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node /Users/egorproskyrin/.claude/get-shit-done/bin/gsd-tools.cjs init resume)
```
