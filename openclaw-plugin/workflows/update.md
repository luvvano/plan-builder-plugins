...
(Paths are relative to your install location: `/Users/egorproskyrin/.claude/` for global, `./.claude/` for local)
...
**If GLOBAL install:**
```bash
rm -f /Users/egorproskyrin/.claude/cache/gsd-update-check.json
```
