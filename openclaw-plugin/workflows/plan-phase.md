...
@/Users/egorproskyrin/.claude/get-shit-done/references/ui-brand.md
</required_reading>
...
```bash
PHASE_INFO=$(node /Users/egorproskyrin/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}")
```
...
5. Commit:
```bash
node /Users/egorproskyrin/.claude/get-shit-done/bin/gsd-tools.cjs commit "docs(${padded_phase}): generate context from PRD" --files "${phase_dir}/${padded_phase}-CONTEXT.md"
```
...
```bash
PHASE_DESC=$(node /Users/egorproskyrin/.claude/get-shit-done/bin/gsd-tools.cjs roadmap get-phase "${PHASE}" | jq -r '.section')
```
...
```
Task(
  prompt="First, read /Users/egorproskyrin/.claude/agents/gsd-phase-researcher.md for your role and instructions.\n\n" + research_prompt,
...
**If found:**
1. Read validation template from `/Users/egorproskyrin/.claude/get-shit-done/templates/VALIDATION.md`
...
```bash
node /Users/egorproskyrin/.claude/get-shit-done/bin/gsd-tools.cjs commit-docs "docs(phase-${PHASE}): add validation strategy"
```
...
```
Task(
  prompt="First, read /Users/egorproskyrin/.claude/agents/gsd-planner.md for your role and instructions.\n\n" + filled_prompt,
  subagent_type="general-purpose",
  model="{planner_model}",
...
Task(
  prompt="
    ...
    @/Users/egorproskyrin/.claude/get-shit-done/references/model-profile-resolution.md
    </execution_context>
