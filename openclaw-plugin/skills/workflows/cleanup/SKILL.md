...
## Step 2: Identify Completed Milestones

Extract each milestone version (e.g., v1.0, v1.1, v2.0) from MILESTONES.md.
...
## Step 3: Determine Phase Membership
...
Ask user to confirm: "Proceed with archiving?" with options:
...
```bash
node "$GSD_TOOLS_PATH" commit "chore: archive phase directories from completed milestones" --files .planning/milestones/ .planning/phases/
```
